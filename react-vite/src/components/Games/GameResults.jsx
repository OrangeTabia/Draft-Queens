...
function GamesList() {
    ...
    if (allTeams && allGames) {
        return (
            <div id='finished-games-container'>
                <div id='finished-games'>
                    <table className='game-table-header'>
                        <tr>
                            <th className='table-header' style={{width:'30%', textAlign:'left', color:'#f76900'}}>COMPLETED GAMES</th>
                    ...
                    {allGames.map((game) => {
                        ...
                        {if (homeTeam && awayTeam) {
                            ...
                            <table className='game-table-body'>
                                <tr>
                                    <td style={{width:'30%', fontSize:'12px'}}>{game.startTime}</td>
                                </tr>
                                <tr>
                                    <td style={{width:'30%', color: 'white'}}><img className='team-logo' src={homeTeam.logo}/>{homeTeam.name}</td>
                                ...
                                <tr>
                                    <td style={{width:'30%', color: 'white'}}><img className='team-logo' src={awayTeam.logo}/>{awayTeam.name}</td>
                                    <td id='final-score' style={{width:'4%'}}>000</td>
                                    <td className='data-field' style={{width:'22%', textAlign:'center'}}>coming soon!</td>
                                    <td className='data-field' style={{width:'22%', textAlign:'center'}}>coming soon!</td>
                                    <td className='data-field' style={{width:'22%', textAlign:'center'}}>coming soon!</td>

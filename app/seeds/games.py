...
def seed_games():
    ...
    game1 = Game(
        ...
        home_team_id=1,
        away_team_id=6,
        start_time=datetime(2024, 5, 26, 6, 0)
    )
    ...
    game2 = Game(
        ...
        home_team_id=2,
        away_team_id=5,
        start_time=datetime(2024, 5, 31, 6, 0)
    )
    ...
    game3 = Game(
        ...
        home_team_id=3,
        away_team_id=4,
        start_time=datetime(2024, 5, 28, 6, 0)
    )
    ...
    game4 = Game(
        ...
        home_team_id=5,
        away_team_id=1,
        start_time=datetime(2024, 6, 1, 6, 0)
    )
    ...
    game5 = Game(
        ...
        home_team_id=4,
        away_team_id=6,
        start_time=datetime(2024, 6, 2, 6, 0)
    )
    ...
    game7 = Game(
        ...
        home_team_id=1,
        away_team_id=4,
        start_time=datetime(2024, 6, 4, 6, 0)
    )
    ...
    game8 = Game(
        ...
        home_team_id=5,
        away_team_id=3,
        start_time=datetime(2024, 6, 5, 6, 0)
    )
